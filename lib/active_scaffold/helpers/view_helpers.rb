  ...
  module Helpers
    ...
    module ViewHelpers
      ...
      def get_action_link_id(url_options, record = nil, column = nil)
        ...
        action_id = "#{id_from_controller(url_options[:controller]) + '-' if url_options[:parent_controller] || link.controller != controller.controller_path}#{url_options[:action].to_s}"
