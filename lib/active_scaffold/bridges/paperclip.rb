class ActiveScaffold::Bridges::Paperclip < ActiveScaffold::DataStructures::Bridge
  def self.install
    if ActiveScaffold::Config::Core.method_defined?(:initialize_with_paperclip)
      fail RuntimeError, "We've detected that you have active_scaffold_paperclip_bridge installed. This plugin has been moved to core. Please remove active_scaffold_paperclip_bridge to prevent any conflicts"
    end
