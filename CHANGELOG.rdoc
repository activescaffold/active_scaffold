...
- Support adding settings for chosen and tinyMCE in initializer (Active scaffold.js_config) or JavaScript code (Active scaffold.config, needed for callbacks)
- Support ruby 3.0
