...
- Stop using cow_proxy for thread safety, added ProxyColumn and require using active_scaffold_config.columns.override(:column_name) to change a column per request, action links can't be changed
- Require using active_scaffold_config.<a.override_columns to exclude or add columns
- Thread safety enabled by default, can't be disabled
