...
![An order form with a Dup link on each subform row](/assets/screenshots/duplicate-subform-before.png)
...
![The order form after duplicating the first subform row](/assets/screenshots/duplicate-subform-after.png)
