...
class TemplateSearchingTest < Test::Unit::TestCase
  ...
  def test_our_templates_from_controller
    ...
    assert_equal ['app/views/current/create_form.rhtml',
                  ...
                  'app/views/../../vendor/plugins/activescaffold/frontends/some_frontend/views/create_form.rhtml',
                  'app/views/../../vendor/plugins/activescaffold/frontends/default/views/create_form.rhtml'],
                 @template.template_paths
  end
  ...
  def test_our_templates_from_view
    ...
    assert_equal ['app/views/current/_create_form.rhtml',
                  ...
                  'app/views/../../vendor/plugins/activescaffold/frontends/some_frontend/views/_create_form.rhtml',
                  'app/views/../../vendor/plugins/activescaffold/frontends/default/views/_create_form.rhtml'],
                 @template.template_paths
  end
