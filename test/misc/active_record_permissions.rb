...
class ActiveRecordPermissionsTest < Test::Unit::TestCase
  ...
  def test_method_combinations_with_default_true
    ...
    fail(@model.authorized_for?(:crud_type => :create, :column => :a2), 'aft')
    ...
    fail(@model.authorized_for?(:crud_type => :read, :column => :a2), 'tft')
